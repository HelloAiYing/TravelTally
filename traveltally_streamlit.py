# -*- coding: utf-8 -*-
"""TravelTally-Streamlit.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1O9eXMuq73B8Ykpw59jXcantLlx6sghNq
"""
...
def convert_usd_to_sgd(usd_amount, exchange_rate=1.35):
    """Convert USD to SGD using a default exchange rate."""
...
def main():
    ...
    if st.button("Compare Destinations"):
        if dest1_name and dest2_name:
            # Get data for both destinations
